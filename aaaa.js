		...
		component.register(
			[
				{ type: "title", label: "Token Joiner" },
				{
					...
					onChange() {
						UtilsUI.saveSettings();
						if (settings.TokenJoiner.enabled && window2.token && window2.token_id) {
							user[vars.token] = window2.token;
							user[vars.token_id] = window2.token_id;
						}
					},
				},
				{
		...
		Hack = function () {
			...
			if (settings.AutoBreadTake.enabled) {
				if (timestamp - settings.nows.autobreadtake > 100) {
					...
					for (const oven of ovens) if (getdist(oven, me) <= 300) client[vars.socket].send(JSON.stringify([packets.ovenTake, oven[vars.pid], oven.id]));

					for (const windmill of windmills) if (getdist(windmill, me) <= 300) client[vars.socket].send(JSON.stringify([packets.windMillTake, windmill[vars.pid], windmill.id]));
			...
			if (settings.AutoBreadPut.enabled) {
				if (timestamp - settings.nows.autobreadput > 100) {
					...
					for (const windmill of windmills) if (getdist(windmill, me) <= 300) client[vars.socket].send(JSON.stringify([packets.windMillPut, 255, windmill[vars.pid], windmill.id]));
		...
		if (typeof argumentsList[0] == "object" && argumentsList[0])
			if (typeof argumentsList[0].type == "number") {
				...
				switch (argumentsList[0].type) {
					...
					case ITEMS.STONE_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10008 : 10009;
						argumentsList[0][vars.draw] = drawSpike.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.GOLD_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10006 : 10007;
						argumentsList[0][vars.draw] = drawSpike.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.DIAMOND_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10004 : 10005;
						argumentsList[0][vars.draw] = drawSpike.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.AMETHYST_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10002 : 10003;
						argumentsList[0][vars.draw] = drawSpike.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.REIDITE_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10000 : 10001;
						argumentsList[0][vars.draw] = drawSpike.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.REIDITE_DOOR_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10022 : 10023;
					...
					case ITEMS.AMETHYST_DOOR_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10020 : 10021;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.DIAMOND_DOOR_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10018 : 10019;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.GOLD_DOOR_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10016 : 10017;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.STONE_DOOR_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10014 : 10015;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.WOOD_DOOR_SPIKE:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10012 : 10013;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.REIDITE_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10034 : 10015;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.REIDITE_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10034 : 10035;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.AMETHYST_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10032 : 10033;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.DIAMOND_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10030 : 10031;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.GOLD_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10028 : 10029;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.STONE_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10026 : 10027;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
					...
					case ITEMS.WOOD_DOOR:
						argumentsList[0].ally = isAlly(argumentsList[0]);
						argumentsList[0].spriteID = argumentsList[0].ally ? 10024 : 10025;
						argumentsList[0][vars.draw] = drawDoor.bind(argumentsList[0], argumentsList[0]);
